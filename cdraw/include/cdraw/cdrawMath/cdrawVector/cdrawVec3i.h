...
extern "C" {
	...
	vecu_t vecLenSq3i(int3_t const v);
	...
	vecu_t vecDistSq3i(int3_t const v_lh, int3_t const v_rh);
	...
	/// <param name="v_rh">Right-hand input vector.</param>
	/// <returns>Squared distance between inputs.</returns>
	vecu_t vecDispDistSq3i(int3_t v_disp_out, int3_t const v_lh, int3_t const v_rh);
	...
	vecb_t vecIsZero3i(int3_t const v);
	...
	vecb_t vecIsNonZero3i(int3_t const v);
